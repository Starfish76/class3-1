...
export function NotFoundPage() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      <p className="text-sm font-semibold uppercase tracking-[0.35em] text-rose-500">404</p>
      ...
      <div className="mt-8 flex gap-3">
        <Link to="/" className="rounded-full bg-rose-500 px-5 py-3 text-sm font-medium text-white shadow-lg shadow-rose-200/80 transition hover:bg-rose-600">
          홈으로
        </Link>
