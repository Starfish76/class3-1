...
const samplePhotos = [
  {
    ...
    alt: '첫 단체 사진 예시',
    className: 'right-8 top-3 w-[15rem] -translate-x-[3cm] -rotate-[10deg] sm:w-[17rem] xl:right-16 xl:w-[18rem]',
  },
  {
  ...
  return (
    <section className="relative isolate flex min-h-full items-center overflow-hidden px-4 py-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto w-full max-w-[88rem] lg:-mt-5 xl:-mt-6"
      >
