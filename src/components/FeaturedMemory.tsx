...
export function FeaturedMemory() {
  return (
    <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      ...
      <div className="flex flex-col justify-center rounded-[2rem] border border-white/70 bg-[linear-gradient(145deg,rgba(255,255,255,0.95),rgba(239,246,255,0.95))] p-8 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-sky-600">Featured Memory</p>
